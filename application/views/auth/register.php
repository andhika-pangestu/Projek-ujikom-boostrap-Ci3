<body class="">
    ...
    <main class=" main-content mt-0">
        <section class="min-vh-100 mb-8">
            <div class="page-header align-items-start min-vh-50 pt-0 pb-11 m-3 border-radius-lg bg-gradient-info">
                    ...
                    <div class="col-xl-5 col-lg-10 col-md-10 mx-auto">
                        <div class="card z-index-0">
                            <div class="card-header text-center pt-3 pb-0">
                                <h5 class="text-info">Registrasi</h5>
                            ...
                            <div class="card-body">
                                <form class="user" method="post" action="<?= base_url('auth/register'); ?>">
                                    ...
                                    <p class="text-sm mt-3 mb-0 text-info">Sudah punya akun? <a href="<?= base_url('auth') ?>" class="text-info font-weight-bolder">Masuk</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
