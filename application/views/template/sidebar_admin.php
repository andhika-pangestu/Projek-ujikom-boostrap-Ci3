...
<div class="fixed-plugin">
    ...
    <div class="card shadow-lg ">
        ...
        <div class="card-body pt-sm-3 pt-0">
            ...
            <p class="text-sm d-xl-none d-block mt-2">Kamu bisa Mengubah tampilan.</p>
            <!-- Navbar Fixed -->
            <div class="mt-3">
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0">
            <img src="<?= base_url('assets/') ?>img/map.png" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-2 font-weight-bold text-gradient-primary">Aplikasi Data Perjalanan</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link  active" href="<?= base_url('admin_Dashboard'); ?>">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <img src="<?= base_url('assets/') ?>img/home.png" width="16px" height="16px" viewBox="0 0 45 40">
                        <title>home </title>
            ...
            <li class="nav-item">
                <a class="nav-link  active" href="<?= base_url('admin_Dashboard/datapengguna'); ?>">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <img src="<?= base_url('assets/') ?>img/form.png ?>" width="16px" height="16px" viewBox="0 0 45 40">
                        <title>shop </title>
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g transform="translate(-1716.000000, -439.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                <g transform="translate(1716.000000, 291.000000)">
            ...
            <ul class="navbar-nav mb-3">
                <li class="nav-item">
                    <a class="nav-link  active" href="<?= base_url('admin_Dashboard/adminperjalanan'); ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <img src="<?= base_url('assets/') ?>img/car.png ?>" width="16px" height="16px" viewBox="0 0 45 40">
                            <title>shop </title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1716.000000, -439.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                        ...
                        <span class="nav-link-text ms-1">Data Perjalanan</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  " href="<?= base_url('admin/logoutAdmin') ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
